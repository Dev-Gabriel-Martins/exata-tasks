    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                ...
                Faça o download de todos os dados ou informações que você deseja reter.
            </p>
        </header>
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Depois que sua conta é excluída, todos os seus recursos e dados
                    será excluído permanentemente.Por favor, digite sua senha para
                    Confirme que você gostaria de excluir permanentemente sua conta.
                </p>
